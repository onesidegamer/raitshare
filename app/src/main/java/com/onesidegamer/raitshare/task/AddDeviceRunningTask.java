package com.onesidegamer.raitshare.task;
...
import com.onesidegamer.raitshare.activity.AddDevicesToTransferActivity;
...
public class AddDeviceRunningTask extends WorkerService.RunningTask<AddDevicesToTransferActivity>
{
    ...
    private final NetworkDevice mDevice;
    private final NetworkDevice.Connection mConnection;
