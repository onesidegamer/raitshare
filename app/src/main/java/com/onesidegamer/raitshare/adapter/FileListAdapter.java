...
import com.onesidegamer.raitshare.util.MimeIconUtils;
        ...
        implements GroupEditableListAdapter.GroupLister.CustomGroupLister<FileListAdapter.GenericFileHolder>
{
    ...
    protected void onLoad(GroupLister<GenericFileHolder> lister)
    {
        ...
        if (path != null) {
            ...
            lister.offerObliged(this, new DirectoryHolder(defaultFolder, getContext().getString(R.string.text_receivedFiles), R.drawable.ic_raitshare_rounded_white_24dp_static));
    ...
    {
        private final FileShortcutObject mShortcutObject;
            ...
            implements StorageHolderImpl
    {
        ...
        public long getId()
        {
            return getViewType() != GroupEditableListAdapter.VIEW_TYPE_ACTION_BUTTON
                    ? super.getId()
                    : String.format("%s_%s_%s", getClass().getName(), iconRes, getRepresentativeText().hashCode()).hashCode();
        }
