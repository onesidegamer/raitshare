package com.onesidegamer.raitshare.service;
...
import com.onesidegamer.raitshare.app.Service;
import com.onesidegamer.raitshare.config.AppConfig;
import com.onesidegamer.raitshare.config.Keyword;
import com.onesidegamer.raitshare.database.AccessDatabase;
import com.onesidegamer.raitshare.exception.AssigneeNotFoundException;
import com.onesidegamer.raitshare.exception.ConnectionNotFoundException;
import com.onesidegamer.raitshare.exception.DeviceNotFoundException;
import com.onesidegamer.raitshare.exception.TransferGroupNotFoundException;
import com.onesidegamer.raitshare.fragment.FileListFragment;
import com.onesidegamer.raitshare.object.NetworkDevice;
import com.onesidegamer.raitshare.object.TextStreamObject;
import com.onesidegamer.raitshare.object.TransferGroup;
import com.onesidegamer.raitshare.object.TransferInstance;
import com.onesidegamer.raitshare.object.TransferObject;
import com.onesidegamer.raitshare.util.AppUtils;
import com.onesidegamer.raitshare.util.CommunicationBridge;
import com.onesidegamer.raitshare.util.CommunicationNotificationHelper;
import com.onesidegamer.raitshare.util.DynamicNotification;
import com.onesidegamer.raitshare.util.FileUtils;
import com.onesidegamer.raitshare.util.HotspotUtils;
import com.onesidegamer.raitshare.util.NetworkDeviceLoader;
import com.onesidegamer.raitshare.util.NetworkUtils;
import com.onesidegamer.raitshare.util.NotificationUtils;
import com.onesidegamer.raitshare.util.NsdDiscovery;
import com.onesidegamer.raitshare.util.TimeUtils;
import com.onesidegamer.raitshare.util.TransferUtils;
import com.onesidegamer.raitshare.util.UpdateUtils;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.genonbeta.raitshare.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.genonbeta.raitshare.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.genonbeta.raitshare.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.genonbeta.raitshare.action.IP";
    public static final String ACTION_END_SESSION = "com.genonbeta.raitshare.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.genonbeta.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.genonbeta.raitshare.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.genonbeta.raitshare.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.genonbeta.raitshare.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.genonbeta.raitshare.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.genonbeta.raitshare.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.genonbeta.raitshare.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.genonbeta.raitshare.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.genonbeta.raitshare.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.genonbeta.raitshare.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.genonbeta.raitshare.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.genonbeta.raitshare.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.genonbeta.raitshare.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.genonbeta.raitshare.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.genonbeta.raitshare.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.genonbeta.raitshare.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.genonbeta.raitshare.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.genonbeta.raitshare.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.genonbeta.raitshare.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.genonbeta.raitshare.transaction.action.REQUEST_WEBSHARE_STATUS";
    ...
    private final Map<Long, Interrupter> mOngoingIndexList = new ArrayMap<>();
