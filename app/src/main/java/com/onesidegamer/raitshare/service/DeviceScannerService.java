...
import com.onesidegamer.raitshare.util.AddressedInterface;
import com.onesidegamer.raitshare.util.AppUtils;
import com.onesidegamer.raitshare.util.NetworkDeviceLoader;
import com.onesidegamer.raitshare.util.NetworkDeviceScanner;
...
public class DeviceScannerService extends Service implements NetworkDeviceScanner.ScannerHandler
{
    ...
    private static final NetworkDeviceScanner mDeviceScanner = new NetworkDeviceScanner();
