...
import com.onesidegamer.raitshare.receiver.NetworkStatusReceiver;
        ...
        implements TitleSupport, IconSupport
{
    ...
    private final UIConnectionUtils.RequestWatcher mHotspotWatcher = new UIConnectionUtils.RequestWatcher()
    {
        @Override
