package com.onesidegamer.raitshare.fragment;
...
import com.onesidegamer.raitshare.activity.ConnectionManagerActivity;
import com.onesidegamer.raitshare.dialog.EstablishConnectionDialog;
import com.onesidegamer.raitshare.adapter.NetworkDeviceListAdapter;
import com.onesidegamer.raitshare.app.EditableListFragment;
import com.onesidegamer.raitshare.callback.OnDeviceSelectedListener;
import com.onesidegamer.raitshare.config.AppConfig;
import com.onesidegamer.raitshare.database.AccessDatabase;
import com.onesidegamer.raitshare.dialog.DeviceInfoDialog;
import com.onesidegamer.raitshare.object.NetworkDevice;
import com.onesidegamer.raitshare.service.DeviceScannerService;
import com.onesidegamer.raitshare.ui.UIConnectionUtils;
import com.onesidegamer.raitshare.ui.callback.DetachListener;
import com.onesidegamer.raitshare.ui.callback.IconSupport;
import com.onesidegamer.raitshare.ui.callback.NetworkDeviceSelectedListener;
import com.onesidegamer.raitshare.ui.callback.TitleSupport;
import com.onesidegamer.raitshare.util.AppUtils;
import com.onesidegamer.raitshare.util.ConnectionUtils;
        ...
        implements TitleSupport, DetachListener, IconSupport, ConnectionManagerActivity.DeviceSelectionSupport
{
    ...
    private final UIConnectionUtils.RequestWatcher mWiFiWatcher = new UIConnectionUtils.RequestWatcher()
    {
        @Override
    ...
    private void openInfo(NetworkDevice device)
    {
        if (device instanceof NetworkDeviceListAdapter.HotspotNetwork) {
            ...
            builder.setMessage(R.string.text_raitshareHotspotDescription);
