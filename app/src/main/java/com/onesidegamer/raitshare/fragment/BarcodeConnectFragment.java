...
import com.onesidegamer.raitshare.activity.TextEditorActivity;
...
import com.onesidegamer.raitshare.ui.UITask;
        ...
        implements TitleSupport, UITask, IconSupport, ConnectionManagerActivity.DeviceSelectionSupport
{
    ...
    private final UIConnectionUtils.RequestWatcher mPermissionWatcher = new UIConnectionUtils.RequestWatcher()
    {
        @Override
    ...
    private final NetworkDeviceLoader.OnDeviceRegisteredListener mRegisteredListener = new NetworkDeviceLoader.OnDeviceRegisteredListener()
    {
        @Override
