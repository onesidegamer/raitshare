...
import com.onesidegamer.raitshare.dialog.ShareAppDialog;
import com.onesidegamer.raitshare.fragment.HomeFragment;
        ...
        implements NavigationView.OnNavigationItemSelectedListener, PowerfulActionModeSupport
{
    ...
    private void applyAwaitingDrawerAction()
    {
        if (mChosenMenuItemId == 0) {
            ...
            try {
                startActivity(new Intent(this, Class.forName("com.onesidegamer.raitshare.activity.DonationActivity")));
                ...
                public void onClick(DialogInterface dialog, int which)
                {
                    try {
                        startActivity(new Intent(Intent.ACTION_VIEW).setData(Uri.parse(
                                "https://sites.google.com/view/raitshare/app"
                        )));
