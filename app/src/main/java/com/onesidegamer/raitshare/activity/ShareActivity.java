...
import com.onesidegamer.raitshare.task.OrganizeShareRunningTask;
        ...
        implements SnackbarSupport, Activity.OnPreloadArgumentWatcher, WorkerService.OnAttachListener
{
    ...
    public static final String ACTION_SEND = "genonbeta.intent.action.raitshare_SEND";
    public static final String ACTION_SEND_MULTIPLE = "genonbeta.intent.action.raitshare_SEND_MULTIPLE";

    public static final String EXTRA_FILENAME_LIST = "extraFileNames";
    public static final String EXTRA_DEVICE_ID = "extraDeviceId";
    public static final String EXTRA_GROUP_ID = "extraGroupId";

    private final Bundle mPreLoadingBundle = new Bundle();
